// Package names is copy/pasted from docker's code source
// The original can be found in package: "github.com/docker/docker/pkg/namesgenerator"
package names
...
var (
	...
	right = [...]string{
		...
		// Cory Slep - Author of go-fed ActivityPub framework
		"slep",
		...
		// Christopher Lemmer Webber - responsible for a big part of the ActivityPub spec
		"webber",
